...
while principalMenu != 0:
    if principalMenu == 1:
        ...
        resLeft = []
        #Validacion y solicitud de datos para la introduccion de las restricciones del problema (lado izquierdo) //pruebapull1
        ...
        resRight = []
        #Validacion y solicitud de datos para la introduccion de las restricciones del problema (lado derecho ; resultados) pruebapull1
        for i in range(num_restricciones):
            while True:
                try:
